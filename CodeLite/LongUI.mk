...
## Objects
##
$(IntermediateDirectory)/up_src_control_ui_spinbuttons.cpp$(ObjectSuffix): ../src/control/ui_spinbuttons.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_src_control_ui_spinbuttons.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/up_src_control_ui_spinbuttons.cpp$(DependSuffix) -MM ../src/control/ui_spinbuttons.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/github/LongUI/src/control/ui_spinbuttons.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_control_ui_spinbuttons.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_src_control_ui_spinbuttons.cpp$(PreprocessSuffix): ../src/control/ui_spinbuttons.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_src_control_ui_spinbuttons.cpp$(PreprocessSuffix) ../src/control/ui_spinbuttons.cpp
...
$(IntermediateDirectory)/up_src_control_ui_grid.cpp$(ObjectSuffix): ../src/control/ui_grid.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_src_control_ui_grid.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/up_src_control_ui_grid.cpp$(DependSuffix) -MM ../src/control/ui_grid.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/github/LongUI/src/control/ui_grid.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_control_ui_grid.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_src_control_ui_grid.cpp$(PreprocessSuffix): ../src/control/ui_grid.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_src_control_ui_grid.cpp$(PreprocessSuffix) ../src/control/ui_grid.cpp
