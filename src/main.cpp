...
namespace LongUI {
    ...
    // IDWriteTextRenderer D3E0E934-22A0-427E-AAE4-7D9574B59DB1
    const GUID IID_IDWriteTextRenderer1 = {
        0xD3E0E934, 0x22A0, 0x427E, { 0xAA, 0xE4, 0x7D, 0x95, 0x74, 0xB5, 0x9D, 0xB1 }
    };
