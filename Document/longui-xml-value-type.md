...
value type|implement|note|e.g.
:--------:|---------|----|----
<a name="jump_enum_bmprule"/>enum bmprule|`Helper::XMLGetBitmapRenderRule`|int or string| `="button"`, `="1"`
...
<a name="jump_enum_fontstyle"/>enum fontstyle|`Helper::XMLGetFontStyle`|int or string| `="clamp"`, `="1"`
...
<a name="jump_enum_extend"/>enum extend|`Helper::XMLGetD2DExtendMode`|int or string| `="mirror"`, `="1"`
---|---|`0` or `clamp`|for `D2D1_EXTEND_MODE_CLAMP`
---|---|`1` or `wrap`|for `D2D1_EXTEND_MODE_WRAP`
---|---|`2` or `mirror`|for `D2D1_EXTEND_MODE_MIRROR`
<a name="jump_enum_valign"/>enum valign|`Helper::XMLGetVAlignment`|int or string| `="top"`, `="1"`
...
<a name="jump_enum_halign"/>enum halign|`Helper::XMLGetHAlignment`|int or string| `="right"`, `="1"`
...
<a name="jump_enum_textantialias"/>enum textantialias|`Helper::XMLGetD2DTextAntialiasMode`|int or string| `="default"`, `="1"`
...
<a name="jump_enum_richtype"/>enum richtype|`Helper::XMLGetRichType`|int or string| `="core"`, `="1"`
...
<a name="jump_enum_flowdirection"/>enum flowdirection|`Helper::XMLGetFlowDirection`|int or string| `="right2left"`, `="1"`
...
<a name="jump_enum_readingdirection"/>enum readingdirection|`Helper::XMLGetReadingDirection`|int or string| `="right2left"`, `="1"`
...
<a name="jump_enum_wordwrapping"/>enum wordwrapping|`Helper::XMLGetWordWrapping`|int or string| `="break"`, `="1"`
...
<a name="jump_enum_interpolation"/>enum interpolation|`Helper::XMLGetD2DInterpolationMode`|int or string| `="highcubic"`, `="1"`
...
<a name="jump_enum_fontstretch"/>enum fontstretch(**unrecommended**)|`Helper::XMLGetFontStretch`|int or string| `="normal"`, `="1"`
...
<a name="jump_enum_animationtype"/>enum animationtype|`Helper::XMLGetAnimationType`|int or string| `="linear"`, `="3"`
